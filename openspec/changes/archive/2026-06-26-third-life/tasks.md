...
- [x] 6.3 Add first-visit onboarding flow — highlights dashboard, explains hearts/streak/XP
- [x] 6.4 Integration tests — seed → complete task → verify XP → streak → achievement unlock
- [x] 6.5 Final UI polish — fix svelte-check warnings, add route transitions, consistent loading/empty/error states
- [x] 6.6 Build static site, verify all routes load, confirm PWA install prompt fires (0 build errors, 182 tests pass)
